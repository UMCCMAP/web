...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/profile', element: <PrivatePages Component={MyprofilePage} /> },
      { path: '/profile/edit', element: <PrivatePages Component={EditprofilePage} /> },
      ...
      { path: '/board', element: <PrivatePages Component={BoardList} /> },
      { path: '/board/modify/:idx', element: <PrivatePages Component={BoardModify} /> },
      { path: '/board/:idx', element: <PrivatePages Component={BoardView} /> },
      { path: '/board/write', element: <PrivatePages Component={BoardWrite} /> },
    ],
  },
]);
